package com.activiti.sequenceFlow;
...
public class SequenceFlow {
	...
	public void processDefined() {
		...
		Deployment deployment = processEngine.getRepositoryService()// 创建流程仓库，放入流程定义,他会默认加载avtiviti.cfg.xml
				...
				.name("sequenceFlow")// 定义部署名
				.addInputStream("sequenceFlow.bpmn", inputStreambpmn).addInputStream("sequenceFlow.png", inputStreampng)
				.deploy();
