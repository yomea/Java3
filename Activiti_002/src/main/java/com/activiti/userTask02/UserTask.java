...
public class UserTask {
	...
	public void runTimeServer() {
		...
		ProcessInstance processInstance = processEngine.getRuntimeService().startProcessInstanceByKey("userTask");
		...
		processEngine.getTaskService().setAssignee(task.getId(), "张无忌");
